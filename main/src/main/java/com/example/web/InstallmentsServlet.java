...
public class InstallmentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String idRaw = req.getParameter("contractId");
        ...
        req.setAttribute("installments", managerDAO.getInstallments(contractId));
        req.getRequestDispatcher("installments.jsp").forward(req, resp);
    }
